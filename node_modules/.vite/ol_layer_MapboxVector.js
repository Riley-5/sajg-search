...
} from "./chunk-MTHURJOE.js";
import {
  VectorRenderTile_default,
  VectorTile_default
} from "./chunk-EAI5YRWF.js";
import "./chunk-TBWZMY6E.js";
import {
  LineString_default,
...
import "./chunk-27MWFN66.js";
import "./chunk-F62XHQY6.js";
import {
  Point_default,
  init_Point
...
import "./chunk-AM34J4Y6.js";
import "./chunk-3UKZBJ7L.js";
import "./chunk-AF5NQ7AC.js";
...
var MVT = function(_super) {
  ...
  function MVT2(opt_options) {
    ...
    _this.featureClass_ = options.featureClass ? options.featureClass : Feature_default2;
  ...
  MVT2.prototype.readProjection = function(source2) {
...
var CanvasVectorTileLayerRenderer = function(_super) {
  __extends2(CanvasVectorTileLayerRenderer2, _super);
  ...
  CanvasVectorTileLayerRenderer2.prototype.updateExecutorGroup_ = function(tile, pixelRatio, projection) {
    ...
    var source2 = layer2.getSource();
    var declutter = layer2.getDeclutter();
    var sourceTileGrid = source2.getTileGrid();
    var tileGrid = source2.getTileGridForProjection(projection);
    var tileExtent = tileGrid.getTileCoordExtent(tile.wrappedTileCoord);
    var sourceTiles = source2.getSourceTiles(pixelRatio, projection, tile);
    ...
    var _loop_1 = function(t4, tt2) {
      ...
      var renderingReplayGroup = new ExecutorGroup_default(replayExtent, resolution, pixelRatio, source2.getOverlaps(), executorGroupInstructions, layer2.getRenderBuffer());
      tile.executorGroups[layerUid].push(renderingReplayGroup);
      if (declutterBuilderGroup) {
        var declutterExecutorGroup = new ExecutorGroup_default(null, resolution, pixelRatio, source2.getOverlaps(), declutterBuilderGroup.finish(), layer2.getRenderBuffer());
  ...
  CanvasVectorTileLayerRenderer2.prototype.forEachFeatureAtCoordinate = function(coordinate, frameState, hitTolerance, callback, matches) {
    ...
    var layer2 = this.getLayer();
    var source2 = layer2.getSource();
    var tileGrid = source2.getTileGridForProjection(frameState.viewState.projection);
      ...
      for (var i = 0, ii = this.renderedTiles.length; i < ii; ++i) {
        if (tileCoord.toString() === this.renderedTiles[i].tileCoord.toString()) {
          ...
          if (tile.getState() === TileState_default.LOADED) {
            ...
            if (source2.getWrapX() && projection.canWrapX() && !containsExtent(projectionExtent, extent_1)) {
  ...
  CanvasVectorTileLayerRenderer2.prototype.getTileRenderTransform = function(tile, frameState) {
    ...
    var source2 = this.getLayer().getSource();
    var tileGrid = source2.getTileGridForProjection(frameState.viewState.projection);
  ...
  CanvasVectorTileLayerRenderer2.prototype.renderTileImage_ = function(tile, frameState) {
    ...
    var size = source2.getTilePixelSize(z, pixelRatio, projection);
...
var VectorTileLayer = function(_super) {
  __extends3(VectorTileLayer2, _super);
...
function validateTerrain(options) {
  ...
  if (!terrain2.source) {
    ...
    const source2 = style.sources && style.sources[terrain2.source];
    const sourceType = source2 && unbundle(source2.type);
    if (!source2) {
...
function stylefunction_default(olLayer, glStyle, source2, resolutions, spriteData, spriteImageUrl, getFonts2) {
  ...
  for (var i = 0, ii = allLayers.length; i < ii; ++i) {
    ...
    var layerId = layer2.id;
    if (typeof source2 == "string" && layer2.source == source2 || source2.indexOf(layerId) !== -1) {
...
function applyStyle(layer2, glStyle, source2, path, resolutions) {
  return new Promise(function(resolve, reject) {
    ...
    function onChange() {
      if (!style && (!glStyle.sprite || spriteData)) {
        style = stylefunction_default(layer2, glStyle, source2, resolutions, spriteData, spriteImageUrl, getFonts);
        if (!layer2.getStyle()) {
          reject(new Error("Nothing to show for source [" + source2 + "]"));
        } else {
          resolve();
        }
      } else if (style) {
  ...
  return new Promise(function(resolve) {
    var key = tilejson.on("change", function() {
      ...
      if (state === "ready") {
        ...
        var source2 = tilejson.get("ol-source");
        if (source2 === void 0) {
          source2 = new VectorTile_default3({
          ...
          tilejson.set("ol-source", source2);
        }
        unByKey(key);
        resolve(source2);
      } else if (state === "error") {
...
var MapboxVectorLayer = function(_super) {
  ...
  MapboxVectorLayer2.prototype.onStyleLoad = function(style) {
    ...
    if (styleSource.url.startsWith("mapbox://") || styleSource.url.indexOf("{z}") !== -1) {
      source2.setUrl(normalizeSourceUrl(styleSource.url, this.accessToken));
      applyStyle(this, style, sourceIdOrLayersList).then(function() {
        source2.setState(State_default.READY);
      }).catch(function(error2) {
        _this.handleError(error2);
      });
    } else {
      setupVectorSource(styleSource, styleSource.url).then(function(source3) {
        applyStyle(_this, style, sourceIdOrLayersList).then(function() {
          _this.setSource(source3);
        }).catch(function(error2) {
          _this.setSource(source3);
          _this.handleError(error2);
        });
  ...
  MapboxVectorLayer2.prototype.handleError = function(error2) {
    ...
    var source2 = this.getSource();
    source2.setState(State_default.ERROR);
  };
